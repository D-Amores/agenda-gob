...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/horizontal-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 15:53:07 GMT -->
 <head>
    <meta charset="utf-8" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('dashboard')}}" method="POST">
                            @csrf
                            <div class="mb-3">
