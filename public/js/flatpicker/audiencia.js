...
// ---------------------- Hora inicio ----------------------
$('#hora_audiencia').val(formatTime(today)); // <--- aquí seteamos hora actual
$('#hora_fin_audiencia').val(formatTime(new Date(today.getTime() + 60 * 60 * 1000))); // hora fin +1h
// Inicializamos restricciones mínimas para hora_fin_evento
$('#hora_fin_audiencia').data('minHour', today.getHours());
$('#hora_fin_audiencia').data('minMinute', today.getMinutes());
